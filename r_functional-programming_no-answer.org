...
*How would you do this? Spend 5 minutes writing code you would usually use.*
...
*Using the src_R[:eval no]{map()} function to get to the same result, how would you do this? Spend 5 min brainstorming on this and feel free to talk to each other!*
...
*Spend 3 min to think about how to do this using src_R[:eval no]{map()}. Feel free to chat with whoever you'd like to.*
...
* Summary of the map functions family
